...
/**
 * \file    test/phpunit/QrcodesFunctionalTest.php
 * \ingroup qrcodes
 ...
 * @package Testqrcodes
 */
class QrcodesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/qrcodes/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('qrcodes/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/qrcodes/admin/about.php');
		$this->authenticate();
		return $this->assertContains('qrcodes/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('qrcodeswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modQrcodes_QrcodesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modQrcodes_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
